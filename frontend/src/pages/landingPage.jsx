...
import { landingPageStyles } from "../components/landingPageStyle";
import {
  ArrowRight,
  Download,
  LayoutDashboard,
  ...
  return (
    <div className={landingPageStyles.container}>
        ...
        <div className={landingPageStyles.headerContainer}>
          <div className={landingPageStyles.logoContainer}>
            <div className={landingPageStyles.logoIcon}>
              <LayoutDashboard className={landingPageStyles.logoIconInner} />
            </div>
          ...
          <div className="hidden md:flex items-center ">
            {user ? (
              ...
              <button
                className={
                  landingPageStyles.desktopAuthButton + "!cursor-pointer"
                }
      ...
      <main className={landingPageStyles.main}>
          ...
          <div className={landingPageStyles.heroGrid}>
            ...
            <div className={landingPageStyles.heroLeft}>
              ...
              <p className={landingPageStyles.description}>
                Create stunning resumes in minutes with our easy-to-use
                templates. No design skills required!
              </p>
                ...
                {rating.map((data, index) => {
                  return (
                    <div className={landingPageStyles.statItem} key={index}>
                      <div
                        className={`${landingPageStyles.statNumber} ${data.gradient}`}
                      >
                        {data.value}
                      </div>
          ...
          <div className={landingPageStyles.featuresContainer}>
            <div className={landingPageStyles.featuresHeader}>
              ...
              <p className={landingPageStyles.featuresDescription}>
                " Craft a clean, modern resume that showcases your skills,
                projects, and experience built for tech talent ready to impress
                recruiters and hiring managers. "
              </p>
            </div>
            <div className={landingPageStyles.featuresGrid}>
              {FeaturesLists.map((data, index) => (
                <div key={index} className={landingPageStyles.featureCard}>
                  <div className={landingPageStyles.featureCardHover}></div>
                  <div
                    className={`${landingPageStyles.featureCardContent} ${data.bg}`}
                  >
                    <div
                      className={`${landingPageStyles.featureIconContainer} ${data.gradient}`}
                    >
                      {data.icon}
                    </div>
            ...
            <div className={landingPageStyles.ctaCard}>
              ...
              <div className={landingPageStyles.ctaCardContent}>
                ...
                <p className={landingPageStyles.ctaDescription}>
                  Join thoushands of Professionals who landed their dream jobs
                  with our platform
                </p>
                <button
        ...
        {/* Contact-US */}
        <section className="pt-16 my-16 sm:pt-24">
           <ContactUs landingPageStyles={landingPageStyles}/>
        </section>
