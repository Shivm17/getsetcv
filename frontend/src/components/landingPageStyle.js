export const landingPageStyles = {
  ...
  // Auth buttons
  desktopAuthButton: "relative cursor-pointer group px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-xl hover:shadow-violet-200",
  ...
  // Buttons
  primaryButton: "group  cursor-pointer relative px-10 py-4 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-violet-200",
  ...
  secondaryButton: "px-8 sm:px-10 cursor-pointer py-3 sm:py-4 border-2 border-violet-200 text-violet-700 font-bold rounded-2xl hover:border-violet-300 cursor-pointer hover:bg-violet-50 transition-all",
